...
3. Rebuild Docker: `cd /Users/you/Projects/runcloud-go && docker build -t dsolutions/rc:latest .`
4. Restart dashboard: `docker stop rc-dashboard && docker rm rc-dashboard && docker run -d --name rc-dashboard -p 8090:8080 -v ~/.rc:/root/.rc -v ~/.ssh:/root/.ssh:ro --restart unless-stopped dsolutions/rc:latest`
